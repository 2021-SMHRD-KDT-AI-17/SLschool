...
<head>
    ...
    <meta property="og:title" content="내 정보 수정">
            ...
            <div id="sh_content">
                <div class="login-container">
                    <div class="login-form">
                      <div class="login-top">
                        <h1 class="login-header">내 정보 수정</h1>
						<form action="updateMember" method="post" class="input-container">
                            ...
                            <div class="input-container">
                              <input type="text" id="user-name" value="${member.name }" name="name" placeholder=" " />
                              <label for="user-name" class="input-prefix">이름</label>
                            </div>
                            ...
                            <input type="submit" id="sign-in" name="Sign-in" value="회원정보 수정" />
                        </form>
                      </div>
                    </div>
                  </div>
