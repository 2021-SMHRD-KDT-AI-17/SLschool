...
<head>
    ...
    <meta property="og:title" content="퀴즈-단어 맞추기">
    <meta property="og:description" content=""><!-- 사이트 설명문구 -->
    <meta property="og:image" content="img/common/logo.png">
    <meta property="og:url" content="">
	<title>퀴즈-단어 맞추기</title>
        ...
        <div id="sh_container_wrapper">
            ...
            <div id="sub_main_banner">
				<div id="sh_content_tit">
					...
					<i class="fa fa-angle-right"></i> 퀴즈 <i class="fa fa-angle-right"></i> 단어 맞추기</p>
				</div>
			</div>
            <!-- sub_main_banner [e] -->
            ...
            <div id="sh_aside">
    	        <div id="sh_snb">
                    <ul>
                        <li><a href="quiz2" style="color: #4D869C;">단어 맞추기</a></li>
                        <li><a href="quizB">수어 해보기</a></li>
                    </ul>            
				</div>
            </div>
