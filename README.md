...
<table>
  ...
  <tr>
    ...
    <td align="center"><b>AI Hub 수어 데이터 분석<br>데이터 전처리<br>MediaPipe를 통한 Keypoint 추출 모델 설계<br>LSTM을 통한 단어 <br>추론 모델 설계<br>멘토링 진행일지 관리</b></td>
    <td align="center"><b>AI Hub 수어 데이터 분석<br>데이터 전처리<br>MediaPipe를 통한 Keypoint 추출 모델 설계<br>LSTM을 통한 단어 <br>추론 모델 설계<br>WBS 관리</b></td>
  </tr>
  <tr>
