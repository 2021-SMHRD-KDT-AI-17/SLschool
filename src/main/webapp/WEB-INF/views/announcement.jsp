    ...
    <div id="board-list">
        <div class="container">
            <table class="board-table">
                <thead>
                <tr>
                	<th scope="col" class="th-date"style="color:black;"><strong>번호</strong></th>
    	...
    	<button class="btn btn-primary btn-sm mt-3" onclick="location.href='goWriteAnnouncement'">작성하기</button>
		<% } %>
        </div>
    </div>
</section>
