                ...
                <div class="col-md-7">
                    ...
                    <form action="writeAnnouncement" method="post">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="5" id="comment" name="content" placeholder="내용"></textarea>
                        </div>
                        <button class="btn btn-block" type="submit">등록하기</button>
                    </form>
                </div>
            </div>
        </div>
