...
<head>
    ...
    <meta property="og:title" content="수어사전">
...
<!--                       <div class="topmenu_line">--> 
                            <ul id="topmenu_line">
                                <li><a href="loginjoin.html"><i data-feather="log-in"></i>Login</a></li>
                                <li><a href="loginjoin.html"><i data-feather="user-plus"></i>Join us</a></li>
                            </ul>
                            <!-- </div> -->
                    </div>
            ...
            <div id="topmenuM">
                ...
                <div id="navWrap">
                    <div class="inner">
                        <ul class="user_tip">
                            <li><a href="loginjoin.html" class="small_tip">회원가입</a></li>
                            <li><a href="loginjoin.html" class="small_tip">로그인</a></li>
                        </ul>
                        <ul class="m_lnb">
                            <li>
    ...
    <div id="sh_container">
        ...
        <div id="sh_container_wrapper">
            ...
            <div id="sh_aside">
    	        <div id="sh_snb">
                    <ul>
                        <li><a href="dictionary.html" style="color: #4D869C;">수어사전</a></li>
                    </ul>            
				</div>
            </div>
             sh_aside [e] -->
